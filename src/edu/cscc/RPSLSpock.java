...
/**
 * @author Om Borkar
 * Description: This class is mainly used for checking the user input, genrate a computer pick, and determine if the computer won or lost.
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick String that the user inputs and checks if there answer is valid
     * @return boolean
    ...
    /**
     * @return generates a random pick for the computer
     *
     */
     ...
     * @return boolean if the computer won or not
     */
